...
export default function ReservationZonesPage() {
  const [selectedZones, setSelectedZones] = useState<number[]>([])

  // Mock data for reservation zones
  const zones = [
    { 
      id: 12, 
      title: "Vip 4", 
      translations: ["EN"],
      image: "/images/zone-vip4.jpg",
      area: "123"
    },
    { 
      id: 11, 
    ...
    <PageLayout>
      <div className="w-full px-6 py-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-medium">Reservation zones</h1>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {zones.map(zone => (
                  <tr key={zone.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">{zone.id}</td>
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">{zone.title}</td>
                    <td className="px-4 py-3 whitespace-nowrap">
                      <div className="flex gap-1">
                        {zone.translations.map((lang, idx) => (
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">{zone.area}</td>
