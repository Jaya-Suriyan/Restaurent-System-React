      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex space-x-2">
            <button className="px-4 py-2 text-sm font-medium text-white bg-gray-500 rounded-md">
              Thai
            </button>
            <button className="flex items-center justify-center w-10 h-10 text-sm font-medium text-white bg-blue-500 rounded-md">
              tr
            </button>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center space-x-1 mb-2 border border-gray-300 rounded-md p-1">
              ...
              <div className="flex items-center space-x-1">
                ...
                <button className="p-1 hover:bg-gray-100 rounded">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="w-5 h-5">
                    <path fill="none" d="M0 0h24v24H0z"/>
                    <path d="M19.417 6.679C20.447 7.773 21 9 21 10.989c0 3.5-2.457 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621-.537.278-1.24.375-1.929.311-1.804-.167-3.226-1.648-3.226-3.489a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.099.49 2.748 1.179zm-10 0C10.447 7.773 11 9 11 10.989c0 3.5-2.457 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621-.537.278-1.24.375-1.929.311C4.591 12.322 3.17 10.841 3.17 9a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.099.49 2.748 1.179z" fill="currentColor"/>
                  </svg>
                </button>
                ...
                <button className="p-1 hover:bg-gray-100 rounded">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="w-5 h-5">
                    <path fill="none" d="M0 0h24v24H0z"/>
                    <path d="M4 3h16a1 1 0 0 1 1 1v7H3V4a1 1 0 0 1 1-1zm0 9h8v9H4a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1zm10 0h6v7a1 1 0 0 1-1 1h-5v-8z" fill="currentColor"/>
                  </svg>
                </button>
              </div>
            ...
            <div className="min-h-[200px] border border-gray-300 rounded-md p-4"></div>
          </div>
